 ...
 */
class TemplateOpenshiftIoV1Controller extends BaseController
{
    /**
     * @var TemplateOpenshiftIoV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return TemplateOpenshiftIoV1Controller The *Singleton* instance.
     */
    ...
    public function getTemplateOpenshiftIoV1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/template.openshift.io/v1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listTemplateOpenshiftIoV1NamespacedTemplate(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createTemplateOpenshiftIoV1NamespacedTemplate(
        $body,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteTemplateOpenshiftIoV1CollectionNamespacedTemplate(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadTemplateOpenshiftIoV1NamespacedTemplate(
        $name,
        $mnamespace,
        $exact = null,
        $export = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceTemplateOpenshiftIoV1NamespacedTemplate(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteTemplateOpenshiftIoV1NamespacedTemplate(
        $body,
        $name,
        $mnamespace,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchTemplateOpenshiftIoV1NamespacedTemplate(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listTemplateOpenshiftIoV1TemplateForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/template.openshift.io/v1/templates';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createTemplateOpenshiftIoV1TemplateForAllNamespaces(
        $body,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchTemplateOpenshiftIoV1NamespacedTemplateList(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchTemplateOpenshiftIoV1NamespacedTemplate(
        $name,
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchTemplateOpenshiftIoV1TemplateListForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/template.openshift.io/v1/watch/templates';
