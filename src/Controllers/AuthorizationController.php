...
{
    /**
     * @var AuthorizationController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AuthorizationController The *Singleton* instance.
     */
    ...
    public function getAuthorizationAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/authorization.k8s.io/';
