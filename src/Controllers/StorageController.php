...
{
    /**
     * @var StorageController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return StorageController The *Singleton* instance.
     */
    ...
    public function getStorageAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/storage.k8s.io/';
