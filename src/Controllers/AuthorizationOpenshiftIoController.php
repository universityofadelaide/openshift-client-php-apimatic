 ...
 */
class AuthorizationOpenshiftIoController extends BaseController
{
    /**
     * @var AuthorizationOpenshiftIoController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AuthorizationOpenshiftIoController The *Singleton* instance.
     */
     ...
     */
    public function getAuthorizationOpenshiftIoAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/authorization.openshift.io/';
