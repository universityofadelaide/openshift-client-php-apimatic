 ...
 */
class SecurityOpenshiftIoController extends BaseController
{
    /**
     * @var SecurityOpenshiftIoController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SecurityOpenshiftIoController The *Singleton* instance.
     */
     ...
     */
    public function getSecurityOpenshiftIoAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/security.openshift.io/';
