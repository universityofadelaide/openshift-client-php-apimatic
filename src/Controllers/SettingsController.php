...
{
    /**
     * @var SettingsController The reference to *Singleton* instance of this class
     */
     ...
     */
    public function getSettingsAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/settings.k8s.io/';
