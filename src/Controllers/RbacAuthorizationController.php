 ...
 */
class RbacAuthorizationController extends BaseController
{
    /**
     * @var RbacAuthorizationController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return RbacAuthorizationController The *Singleton* instance.
     */
    ...
    public function getRbacAuthorizationAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/rbac.authorization.k8s.io/';
