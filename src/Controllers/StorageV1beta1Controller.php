 ...
 */
class StorageV1beta1Controller extends BaseController
{
    /**
     * @var StorageV1beta1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return StorageV1beta1Controller The *Singleton* instance.
     */
    ...
    public function getStorageV1beta1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/storage.k8s.io/v1beta1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listStorageV1beta1StorageClass(
        $fieldSelector = null,
        $labelSelector = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/storage.k8s.io/v1beta1/storageclasses';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createStorageV1beta1StorageClass(
        $body,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteStorageV1beta1CollectionStorageClass(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadStorageV1beta1StorageClass(
        $name,
        $exact = null,
        $export = null,
        $pretty = null
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/storage.k8s.io/v1beta1/storageclasses/{name}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceStorageV1beta1StorageClass(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteStorageV1beta1StorageClass(
        $body,
        $name,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchStorageV1beta1StorageClass(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchStorageV1beta1StorageClassList(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/storage.k8s.io/v1beta1/watch/storageclasses';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchStorageV1beta1StorageClass(
        $name,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/storage.k8s.io/v1beta1/watch/storageclasses/{name}';
