 ...
 */
class QuotaOpenshiftIoV1Controller extends BaseController
{
    /**
     * @var QuotaOpenshiftIoV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return QuotaOpenshiftIoV1Controller The *Singleton* instance.
     */
    ...
    public function getQuotaOpenshiftIoV1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/quota.openshift.io/v1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listQuotaOpenshiftIoV1AppliedClusterResourceQuotaForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/quota.openshift.io/v1/appliedclusterresourcequotas';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listQuotaOpenshiftIoV1ClusterResourceQuota(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/quota.openshift.io/v1/clusterresourcequotas';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createQuotaOpenshiftIoV1ClusterResourceQuota(
        $body,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteQuotaOpenshiftIoV1CollectionClusterResourceQuota(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadQuotaOpenshiftIoV1ClusterResourceQuota(
        $name,
        $exact = null,
        $export = null,
        $pretty = null
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/quota.openshift.io/v1/clusterresourcequotas/{name}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceQuotaOpenshiftIoV1ClusterResourceQuota(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteQuotaOpenshiftIoV1ClusterResourceQuota(
        $body,
        $name,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchQuotaOpenshiftIoV1ClusterResourceQuota(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadQuotaOpenshiftIoV1ClusterResourceQuotaStatus(
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceQuotaOpenshiftIoV1ClusterResourceQuotaStatus(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchQuotaOpenshiftIoV1ClusterResourceQuotaStatus(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listQuotaOpenshiftIoV1NamespacedAppliedClusterResourceQuota(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadQuotaOpenshiftIoV1NamespacedAppliedClusterResourceQuota(
        $name,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchQuotaOpenshiftIoV1ClusterResourceQuotaList(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/quota.openshift.io/v1/watch/clusterresourcequotas';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchQuotaOpenshiftIoV1ClusterResourceQuota(
        $name,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
