 ...
 */
class AutoscalingV1Controller extends BaseController
{
    /**
     * @var AutoscalingV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AutoscalingV1Controller The *Singleton* instance.
     */
    ...
    public function getAutoscalingV1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/autoscaling/v1/';
    ...
    public function listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/autoscaling/v1/horizontalpodautoscalers';
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1HorizontalPodAutoscalerList');
    }

    /**
     * create a HorizontalPodAutoscaler
     *
     * @param Models\V1HorizontalPodAutoscaler $body   TODO: type description here
     * @param string                           $pretty (optional) If 'true', then the output is pretty printed.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createAutoscalingV1HorizontalPodAutoscalerForAllNamespaces(
        $body,
        $pretty = null
    ) {
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1HorizontalPodAutoscaler');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadAutoscalingV1NamespacedHorizontalPodAutoscaler(
        $name,
        $mnamespace,
        $exact = null,
        $export = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceAutoscalingV1NamespacedHorizontalPodAutoscaler(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(
        $name,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/autoscaling/v1/watch/horizontalpodautoscalers';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchAutoscalingV1NamespacedHorizontalPodAutoscalerList(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchAutoscalingV1NamespacedHorizontalPodAutoscaler(
        $name,
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
