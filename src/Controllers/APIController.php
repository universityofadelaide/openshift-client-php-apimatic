...
class APIController extends BaseController
{
     ...
     */
    public function createNamespacedProcessedTemplateV1(
        $body,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createProcessedTemplateForAllNamespaces(
        $body,
        $pretty = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/template.openshift.io/v1/processedtemplates';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createNamespacedProcessedTemplate(
        $body,
        $mnamespace,
        $pretty = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/oapi/v1/namespaces/{namespace}/processedtemplates';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createProcessedTemplateForAllNamespacesV1(
        $body,
        $pretty = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/oapi/v1/processedtemplates';
