 ...
 */
class AuthenticationV1beta1Controller extends BaseController
{
    /**
     * @var AuthenticationV1beta1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AuthenticationV1beta1Controller The *Singleton* instance.
     */
     ...
     */
    public function getAuthenticationV1beta1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/authentication.k8s.io/v1beta1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createAuthenticationV1beta1TokenReview(
        $body,
        $pretty = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/authentication.k8s.io/v1beta1/tokenreviews';
