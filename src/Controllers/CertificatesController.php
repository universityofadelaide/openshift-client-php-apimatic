...
{
    /**
     * @var CertificatesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CertificatesController The *Singleton* instance.
     */
    ...
    public function getCertificatesAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/certificates.k8s.io/';
