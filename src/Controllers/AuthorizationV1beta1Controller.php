 ...
 */
class AuthorizationV1beta1Controller extends BaseController
{
    /**
     * @var AuthorizationV1beta1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AuthorizationV1beta1Controller The *Singleton* instance.
     */
    ...
    public function getAuthorizationV1beta1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/authorization.k8s.io/v1beta1/';
     ...
     *
     * @param Models\V1beta1LocalSubjectAccessReview $body   TODO: type description here
     * @param string                                 $pretty (optional) If 'true', then the output is pretty printed.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createAuthorizationV1beta1LocalSubjectAccessReviewForAllNamespaces(
        $body,
        $pretty = null
    ) {
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1beta1LocalSubjectAccessReview');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createAuthorizationV1beta1SubjectAccessReview(
        $body,
        $pretty = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/authorization.k8s.io/v1beta1/subjectaccessreviews';
