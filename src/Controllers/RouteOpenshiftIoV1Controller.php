 ...
 */
class RouteOpenshiftIoV1Controller extends BaseController
{
    /**
     * @var RouteOpenshiftIoV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return RouteOpenshiftIoV1Controller The *Singleton* instance.
     */
    ...
    public function getRouteOpenshiftIoV1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/route.openshift.io/v1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listRouteOpenshiftIoV1NamespacedRoute(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/route.openshift.io/v1/namespaces/{namespace}/routes';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createRouteOpenshiftIoV1NamespacedRoute(
        $body,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteRouteOpenshiftIoV1CollectionNamespacedRoute(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadRouteOpenshiftIoV1NamespacedRoute(
        $name,
        $mnamespace,
        $exact = null,
        $export = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceRouteOpenshiftIoV1NamespacedRoute(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteRouteOpenshiftIoV1NamespacedRoute(
        $body,
        $name,
        $mnamespace,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchRouteOpenshiftIoV1NamespacedRoute(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadRouteOpenshiftIoV1NamespacedRouteStatus(
        $name,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceRouteOpenshiftIoV1NamespacedRouteStatus(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchRouteOpenshiftIoV1NamespacedRouteStatus(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listRouteOpenshiftIoV1RouteForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/route.openshift.io/v1/routes';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createRouteOpenshiftIoV1RouteForAllNamespaces(
        $body,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchRouteOpenshiftIoV1NamespacedRouteList(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchRouteOpenshiftIoV1NamespacedRoute(
        $name,
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchRouteOpenshiftIoV1RouteListForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/route.openshift.io/v1/watch/routes';
