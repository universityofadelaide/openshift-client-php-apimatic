 ...
 */
class SecurityOpenshiftIoV1Controller extends BaseController
{
    /**
     * @var SecurityOpenshiftIoV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SecurityOpenshiftIoV1Controller The *Singleton* instance.
     */
    ...
    public function getSecurityOpenshiftIoV1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/security.openshift.io/v1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSecurityOpenshiftIoV1NamespacedPodSecurityPolicyReview(
        $body,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSecurityOpenshiftIoV1NamespacedPodSecurityPolicySelfSubjectReview(
        $body,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSecurityOpenshiftIoV1NamespacedPodSecurityPolicySubjectReview(
        $body,
        $mnamespace,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSecurityOpenshiftIoV1PodSecurityPolicyReviewForAllNamespaces(
        $body,
        $pretty = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/security.openshift.io/v1/podsecuritypolicyreviews';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSecurityOpenshiftIoV1PodSecurityPolicySelfSubjectReviewForAllNamespaces(
        $body,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSecurityOpenshiftIoV1PodSecurityPolicySubjectReviewForAllNamespaces(
        $body,
        $pretty = null
    ) {
