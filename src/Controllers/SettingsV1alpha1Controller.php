 ...
 */
class SettingsV1alpha1Controller extends BaseController
{
    /**
     * @var SettingsV1alpha1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SettingsV1alpha1Controller The *Singleton* instance.
     */
     ...
     */
    public function getSettingsV1alpha1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/settings.k8s.io/v1alpha1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listSettingsV1alpha1NamespacedPodPreset(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1alpha1PodPresetList');
    }

    /**
     * create a PodPreset
     *
     * @param Models\V1alpha1PodPreset $body      TODO: type description here
     * @param string                   $mnamespace object name and auth scope, such as for teams and projects
     * @param string                   $pretty    (optional) If 'true', then the output is pretty printed.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSettingsV1alpha1NamespacedPodPreset(
        $body,
        $mnamespace,
        $pretty = null
    ) {
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1alpha1PodPreset');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteSettingsV1alpha1CollectionNamespacedPodPreset(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadSettingsV1alpha1NamespacedPodPreset(
        $name,
        $mnamespace,
        $exact = null,
        $export = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceSettingsV1alpha1NamespacedPodPreset(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteSettingsV1alpha1NamespacedPodPreset(
        $body,
        $name,
        $mnamespace,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchSettingsV1alpha1NamespacedPodPreset(
        $body,
        $name,
        $mnamespace,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listSettingsV1alpha1PodPresetForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/settings.k8s.io/v1alpha1/podpresets';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSettingsV1alpha1PodPresetForAllNamespaces(
        $body,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchSettingsV1alpha1NamespacedPodPresetList(
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchSettingsV1alpha1NamespacedPodPreset(
        $name,
        $mnamespace,
        $fieldSelector = null,
        $labelSelector = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchSettingsV1alpha1PodPresetListForAllNamespaces(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/apis/settings.k8s.io/v1alpha1/watch/podpresets';
