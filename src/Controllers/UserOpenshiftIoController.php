 ...
 */
class UserOpenshiftIoController extends BaseController
{
    /**
     * @var UserOpenshiftIoController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return UserOpenshiftIoController The *Singleton* instance.
     */
     ...
     */
    public function getUserOpenshiftIoAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/user.openshift.io/';
