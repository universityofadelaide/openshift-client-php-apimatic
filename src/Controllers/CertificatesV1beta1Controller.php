 ...
 */
class CertificatesV1beta1Controller extends BaseController
{
    /**
     * @var CertificatesV1beta1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CertificatesV1beta1Controller The *Singleton* instance.
     */
    ...
    public function getCertificatesV1beta1APIResources()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/certificates.k8s.io/v1beta1/';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listCertificatesV1beta1CertificateSigningRequest(
        $fieldSelector = null,
        $labelSelector = null,
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1beta1CertificateSigningRequestList');
    }

    /**
     * create a CertificateSigningRequest
     *
     * @param Models\V1beta1CertificateSigningRequest $body   TODO: type description here
     * @param string                                  $pretty (optional) If 'true', then the output is pretty printed.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createCertificatesV1beta1CertificateSigningRequest(
        ...
        return $mapper->mapClass($response->body, 'OpenShiftAPIWithKubernetesLib\\Models\\V1beta1CertificateSigningRequest');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteCertificatesV1beta1CollectionCertificateSigningRequest(
        $fieldSelector = null,
        $labelSelector = null,
        $resourceVersion = null,
        $timeoutSeconds = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getReadCertificatesV1beta1CertificateSigningRequest(
        $name,
        $exact = null,
        $export = null,
        $pretty = null
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceCertificatesV1beta1CertificateSigningRequest(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function patchCertificatesV1beta1CertificateSigningRequest(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceCertificatesV1beta1CertificateSigningRequestApproval(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateReplaceCertificatesV1beta1CertificateSigningRequestStatus(
        $body,
        $name,
        $pretty = null
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchCertificatesV1beta1CertificateSigningRequestList(
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
        $resourceVersion = null,
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getWatchCertificatesV1beta1CertificateSigningRequest(
        $name,
        $fieldSelector = null,
        $labelSelector = null,
        $pretty = null,
