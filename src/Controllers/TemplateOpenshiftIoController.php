 ...
 */
class TemplateOpenshiftIoController extends BaseController
{
    /**
     * @var TemplateOpenshiftIoController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return TemplateOpenshiftIoController The *Singleton* instance.
     */
     ...
     */
    public function getTemplateOpenshiftIoAPIGroup()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/apis/template.openshift.io/';
