 ...
 */
class V1LimitRange implements JsonSerializable
{
    /**
     ...
     * @var V1LimitRangeSpec|null $spec public property
     */
    public $spec;
     ...
     * @param V1LimitRangeSpec $spec       Initialization value for $this->spec
     */
