...
/**
 * ImageStreamMapping represents a mapping from a single tag to a Docker image as well as the reference
 * to the Docker image stream the image came from.
 */
class V1ImageStreamMapping implements JsonSerializable
{
    /**
