...
/**
 * SubjectRulesReview is a resource you can create to determine which actions another user can perform
 * in a namespace
 */
class V1SubjectRulesReview implements JsonSerializable
{
    /**
     * Spec adds information about how to conduct the check
     * @required
     * @var V1SubjectRulesReviewSpec $spec public property
     */
    public $spec;
     ...
     * @param V1SubjectRulesReviewSpec   $spec       Initialization value for $this->spec
