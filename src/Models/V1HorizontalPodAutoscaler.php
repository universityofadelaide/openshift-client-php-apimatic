 ...
 */
class V1HorizontalPodAutoscaler implements JsonSerializable
{
    /**
     ...
     * @var V1HorizontalPodAutoscalerSpec|null $spec public property
     */
    public $spec;
     ...
     * @param V1HorizontalPodAutoscalerSpec   $spec       Initialization value for $this->spec
