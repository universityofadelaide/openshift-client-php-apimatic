 ...
 */
class V1beta1NetworkPolicy implements JsonSerializable
{
    /**
     ...
     * @var V1beta1NetworkPolicySpec|null $spec public property
     */
    public $spec;
     ...
     * @param V1beta1NetworkPolicySpec $spec       Initialization value for $this->spec
     */
