 ...
 */
class V1beta1LocalSubjectAccessReview implements JsonSerializable
{
    /**
     * Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.
     * @required
     * @var V1beta1SubjectAccessReviewSpec $spec public property
     */
    public $spec;
     ...
     * @param V1beta1SubjectAccessReviewSpec $spec       Initialization value for $this->spec
