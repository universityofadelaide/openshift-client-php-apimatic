 ...
 * node. More info: http://kubernetes.io/docs/user-guide/persistent-volumes
 */
class V1PersistentVolume implements JsonSerializable
{
    /**
     ...
     * @var V1PersistentVolumeSpec|null $spec public property
     */
    public $spec;
     ...
     * @var V1PersistentVolumeStatus|null $status public property
     */
    public $status;
     ...
     * @param V1PersistentVolumeSpec   $spec       Initialization value for $this->spec
     * @param V1PersistentVolumeStatus $status     Initialization value for $this->status
     */
