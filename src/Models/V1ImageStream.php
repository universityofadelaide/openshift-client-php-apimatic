...
/**
 * ImageStream stores a mapping of tags to images, metadata overrides that are applied when images are
 * tagged in a stream, and an optional reference to a Docker image repository on a registry.
 */
class V1ImageStream implements JsonSerializable
{
    /**
     * Spec describes the desired state of this stream
     * @required
     * @var V1ImageStreamSpec $spec public property
     */
    public $spec;
     ...
     * @var V1ImageStreamStatus|null $status public property
     */
    public $status;

    /**
     * Constructor to set initial or default values of member properties
     * @param V1ImageStreamSpec   $spec       Initialization value for $this->spec
     ...
     * @param V1ImageStreamStatus $status     Initialization value for $this->status
     */
