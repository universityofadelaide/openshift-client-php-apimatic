 ...
 */
class V1beta1HorizontalPodAutoscaler implements JsonSerializable
{
    /**
     ...
     * @var V1beta1HorizontalPodAutoscalerSpec|null $spec public property
     */
    public $spec;

    /**
     * current information about the autoscaler.
     * @var V1HorizontalPodAutoscalerStatus|null $status public property
     */
    public $status;
     ...
     * @param V1beta1HorizontalPodAutoscalerSpec $spec       Initialization value for $this->spec
     * @param V1HorizontalPodAutoscalerStatus    $status     Initialization value for $this->status
     */
