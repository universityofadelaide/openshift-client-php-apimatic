 ...
 */
class V1Binding implements JsonSerializable
{
    /**
     * The target object that you want to bind to the standard object.
     * @required
     * @var V1ObjectReference $target public property
     */
    public $target;
     ...
     * @param V1ObjectReference $target     Initialization value for $this->target
