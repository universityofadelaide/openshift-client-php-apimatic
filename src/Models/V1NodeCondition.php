 ...
 */
class V1NodeCondition implements JsonSerializable
{
    /**
     ...
     * @var string|null $lastHeartbeatTime public property
     */
     ...
     * @param string $lastHeartbeatTime  Initialization value for $this->lastHeartbeatTime
    ...
    public function __construct()
    {
        if (6 == func_num_args()) {
            ...
            $this->lastHeartbeatTime  = func_get_arg(2);
    ...
    public function jsonSerialize()
    {
        ...
        $json['type']               = $this->type;
        $json['lastHeartbeatTime']  = $this->lastHeartbeatTime;
