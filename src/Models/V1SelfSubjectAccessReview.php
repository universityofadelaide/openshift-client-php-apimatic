 ...
 * spec.namespace means "in all namespaces".  Self is a special case, because users should always be
 * able to check whether they can perform an action
 */
class V1SelfSubjectAccessReview implements JsonSerializable
{
    /**
     * Spec holds information about the request being evaluated.  user and groups must be empty
     * @required
     * @var V1SelfSubjectAccessReviewSpec $spec public property
     */
    public $spec;
     ...
     * @var V1SubjectAccessReviewStatus|null $status public property
     */
    public $status;

    /**
     * Constructor to set initial or default values of member properties
     * @param V1SelfSubjectAccessReviewSpec $spec       Initialization value for $this->spec
     ...
     * @param V1SubjectAccessReviewStatus   $status     Initialization value for $this->status
     */
