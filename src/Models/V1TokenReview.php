 ...
 */
class V1TokenReview implements JsonSerializable
{
    /**
     * Spec holds information about the request being evaluated
     * @required
     * @var V1TokenReviewSpec $spec public property
     */
    public $spec;
     ...
     * @var V1TokenReviewStatus|null $status public property
     */
    public $status;

    /**
     * Constructor to set initial or default values of member properties
     * @param V1TokenReviewSpec   $spec       Initialization value for $this->spec
     ...
     * @param V1TokenReviewStatus $status     Initialization value for $this->status
     */
