 ...
 */
class V2alpha1CronJob implements JsonSerializable
{
    /**
     ...
     * @var V2alpha1CronJobSpec|null $spec public property
     */
    public $spec;
     ...
     * @var V2alpha1CronJobStatus|null $status public property
     */
    public $status;
     ...
     * @param V2alpha1CronJobSpec   $spec       Initialization value for $this->spec
     * @param V2alpha1CronJobStatus $status     Initialization value for $this->status
     */
