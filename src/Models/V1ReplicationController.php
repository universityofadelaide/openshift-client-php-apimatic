 ...
 */
class V1ReplicationController implements JsonSerializable
{
    /**
     ...
     * @var V1ReplicationControllerSpec|null $spec public property
     */
    public $spec;
     ...
     * @param V1ReplicationControllerSpec   $spec       Initialization value for $this->spec
