 ...
 */
class V1beta1DaemonSet implements JsonSerializable
{
    /**
     ...
     * @var V1beta1DaemonSetSpec|null $spec public property
     */
    public $spec;
     ...
     * @var V1beta1DaemonSetStatus|null $status public property
     */
    public $status;
     ...
     * @param V1beta1DaemonSetSpec   $spec       Initialization value for $this->spec
     * @param V1beta1DaemonSetStatus $status     Initialization value for $this->status
     */
