 ...
 */
class V1APIVersions implements JsonSerializable
{
    /**
     ...
     * @required
     * @var array $versions public property
     */
    public $versions;
     ...
     * @param array  $serverAddressByClientCIDRs Initialization value for $this->serverAddressByClientCIDRs
    ...
    {
        if (4 == func_num_args()) {
            $this->serverAddressByClientCIDRs = func_get_arg(0);
            $this->versions                   = func_get_arg(1);
