 ...
 */
class V1Namespace implements JsonSerializable
{
    /**
     ...
     * @var V1NamespaceSpec|null $spec public property
     */
    public $spec;
     ...
     * @var V1NamespaceStatus|null $status public property
     */
    public $status;
     ...
     * @param V1NamespaceSpec   $spec       Initialization value for $this->spec
     * @param V1NamespaceStatus $status     Initialization value for $this->status
     */
