 ...
 * etcd).
 */
class V1Node implements JsonSerializable
{
    /**
     ...
     * @var V1NodeSpec|null $spec public property
     */
    public $spec;
     ...
     * @var V1NodeStatus|null $status public property
     */
    public $status;
     ...
     * @param V1NodeSpec   $spec       Initialization value for $this->spec
     * @param V1NodeStatus $status     Initialization value for $this->status
     */
