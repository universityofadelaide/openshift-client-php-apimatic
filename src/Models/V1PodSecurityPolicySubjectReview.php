...
/**
 * PodSecurityPolicySubjectReview checks whether a particular user/SA tuple can create the
 * PodTemplateSpec.
 */
class V1PodSecurityPolicySubjectReview implements JsonSerializable
{
    /**
     * spec defines specification for the PodSecurityPolicySubjectReview.
     * @required
     * @var V1PodSecurityPolicySubjectReviewSpec $spec public property
     */
    public $spec;
     ...
     * @param V1PodSecurityPolicySubjectReviewSpec   $spec       Initialization value for $this->spec
